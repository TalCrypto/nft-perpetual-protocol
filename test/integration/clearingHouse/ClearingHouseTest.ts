...
describe("ClearingHouse Test", () => {
    ...
    describe("openInterestNotional", () => {
        ...
        it("is 0 when everyone close position, one of them is bankrupt position", async () => {
            ...
            await clearingHouse.connect(bob).liquidate(amm.address, alice.getAddress())
    ...
    //         await approve(alice, clearingHouse.address, 600)
    //         await clearingHouse.openPosition(amm.address, Side.BUY, toDecimal(300).toString(), toDecimal(2).toString(), toDecimal(37.5).toString(), {
    //             from: alice,
    //         })

    //         // given bob takes 1x short position (-187.5B) with 1200 margin
    //         await approve(bob, clearingHouse.address, 1200)
    //         await clearingHouse.openPosition(amm.address, Side.SELL, toDecimal(1200).toString(), toDecimal(1).toString(), toDecimal(187.5).toString(), {
    //             from: bob,
    //         })
    ...
    //         await mockPriceFeed.setTwapPrice(toFullDigit(1.59).toString())
    ...
    //         await mockPriceFeed.setTwapPrice(toFullDigit(1.61).toString())
    //         await gotoNextFundingTime()
    //         await clearingHouse.payFunding(amm.address)
    //         expect(await clearingHouse.getLatestCumulativePremiumFraction(amm.address)).eq(toFullDigit(0.01))
    //         expect((await clearingHouseViewer.getPersonalPositionWithFundingPayment(amm.address, alice)).margin).eq(
    ...
    //         await mockPriceFeed.setTwapPrice(toFullDigit(21.6).toString())
    //         await gotoNextFundingTime()
    //         await clearingHouse.payFunding(amm.address)
    ...
    //         await clearingHouse.removeMargin(amm.address, toDecimal(400).toString(), { from: alice })
    ...
    //         await clearingHouse.addMargin(amm.address, toDecimal(1).toString(), { from: bob })
    //         expect((await clearingHouseViewer.getPersonalPositionWithFundingPayment(amm.address, bob)).margin).eq(
    //             toFullDigit(0),
    //         )
    //     })
    ...
    //         await expectRevert(
    //             clearingHouse.removeMargin(amm.address, toDecimal(1).toString(), { from: bob }),
    ...
    //     //     await clearingHouse.addMargin(amm.address, toDecimal(10).toString(), { from: bob })
    ...
    //         await mockPriceFeed.setTwapPrice(toFullDigit(1.6).toString())
    ...
    //         await clearingHouse.openPosition(amm.address, Side.BUY, toDecimal(25).toString(), toDecimal(10).toString(), toDecimal(20).toString(), {
    //             from: alice,
    //         })
    ...
    //         await clearingHouse.openPosition(amm.address, Side.SELL, toDecimal(15).toString(), toDecimal(10).toString(), toDecimal(0).toString(), {
    //             from: bob,
    //         })
    ...
    //         await clearingHouse.openPosition(amm.address, Side.SELL, toDecimal(25).toString(), toDecimal(10).toString(), toDecimal(33.4).toString(), {
    //             from: alice,
    //         })
    ...
    //         await approve(bob, clearingHouse.address, 2000)
    //         await clearingHouse.openPosition(amm.address, Side.BUY, toDecimal(15).toString(), toDecimal(10).toString(), toDecimal(0).toString(), {
    //             from: bob,
    //         })
    ...
    //             await mockPriceFeed.setTwapPrice(toFullDigit(15.5).toString())
    ...
    //             await mockPriceFeed.setTwapPrice(toFullDigit(15.7).toString())
    ...
    //             })
    //             // price: 800 / 125 = 6.4
    //             await clearingHouse.openPosition(amm.address, Side.SELL, toDecimal(45).toString(), toDecimal(10).toString(), toDecimal(45).toString(), {
    //                 from: bob,
    //             })

    //             // given the underlying twap price: 6.3
    //             await mockPriceFeed.setTwapPrice(toFullDigit(6.3).toString())
    ...
    //             await mockPriceFeed.setTwapPrice(toFullDigit(6.5).toString())
    ...
    //         await clearingHouse.setPartialLiquidationRatio(toDecimal(0.25).toString())
    //         await clearingHouse.setLiquidationFeeRatio(toDecimal(0.025).toString())
    //     })
    ...
    //         await clearingHouse.setMaintenanceMarginRatio(toDecimal(0.1).toString(), { from: admin })

    //         // when alice create a 25 margin * 10x position to get 20 long position
    //         // AMM after: 1250 : 80
    //         await clearingHouse.openPosition(amm.address, Side.BUY, toDecimal(25).toString(), toDecimal(10).toString(), toDecimal(0).toString(), {
    //             from: alice,
    //         })
    ...
    //             amm.address,
    //             Side.SELL,
    //             toDecimal(45.18072289).toString(),
    //             toDecimal(1).toString(),
    ...
    //         const receipt = await clearingHouse.liquidateWithSlippage(amm.address, alice, toDecimal(0).toString(), { from: carol })
    ...
    //         await expectRevert(
    //             clearingHouse.liquidateWithSlippage(amm.address, alice, toDecimal(273.85).toString(), { from: carol }),
    //             "Less than minimal quote token",
    //         )

    //         // if quoteAssetAmountLimit == 273.8 < 68.455 * 4 = 273.82, quote asset gets is more than expected
    //         await clearingHouse.liquidateWithSlippage(amm.address, alice, toDecimal(273.8).toString(), { from: carol })
    //     })
    ...
    //         // AMM after: 800 : 125
    //         await clearingHouse.openPosition(amm.address, Side.SELL, toDecimal(20).toString(), toDecimal(10).toString(), toDecimal(0).toString(), {
    //             from: alice,
    //         })
    ...
    //             amm.address,
    //             Side.BUY,
    //             toDecimal(19.67213115).toString(),
    //             toDecimal(1).toString(),
    //             toDecimal(0).toString(),
    //             { from: bob },
    //         )
    ...
    //         await expectRevert(
    //             clearingHouse.liquidateWithSlippage(amm.address, alice, toDecimal(177).toString(), { from: carol }),
    //             "More than maximal quote token",
    //         )

    //         // if quoteAssetAmountLimit == 177.1 < 44.258 * 4 = 177.032, quote asset pays is less than expected
    //         await clearingHouse.liquidateWithSlippage(amm.address, alice, toDecimal(177.1).toString(), { from: carol })
    //     })
    ...
    //             amm.address,
    //             Side.SELL,
    //             toDecimal(73.52941176).toString(),
    //             toDecimal(1).toString(),
    //             toDecimal(0).toString(),
    //             { from: bob },
    //         )

    //         const receipt = await clearingHouse.liquidateWithSlippage(amm.address, alice, toDecimal(0).toString(), {
    //             from: carol,
    //         })
    ...
    //         await expectRevert(
    //             clearingHouse.liquidateWithSlippage(amm.address, alice, toDecimal(224.1).toString(), {
    //                 from: carol,
    //             }),
    //             "Less than minimal quote token",
    //         )

    //         await clearingHouse.liquidateWithSlippage(amm.address, alice, toDecimal(224).toString(), {
    //             from: carol,
    //         })
    //     })
    ...
    //             amm.address,
    //             Side.BUY,
    //             toDecimal(40.33613445).toString(),
    //             toDecimal(1).toString(),
    //             toDecimal(0).toString(),
    //             {
    //                 from: bob,
    ...
    //         await clearingHouse.openPosition(amm.address, Side.BUY, toDecimal(20).toString(), toDecimal(5).toString(), toDecimal(9.09).toString(), {
    //             from: bob,
    //         })
    ...
    //         await forwardBlockTimestamp(15)
    //         await clearingHouse.openPosition(amm.address, Side.BUY, toDecimal(20).toString(), toDecimal(5).toString(), toDecimal(7.57).toString(), {
    //             from: alice,
    //         })
    ...
    //         await clearingHouse.openPosition(amm.address, Side.SELL, toDecimal(20).toString(), toDecimal(5).toString(), toDecimal(7.58).toString(), {
    //             from: bob,
    //         })
    ...
    //         await syncAmmPriceToOracle()
    //         await expectRevert(
    //             clearingHouse.liquidateWithSlippage(amm.address, alice, toDecimal(0).toString(), {
    //                 from: carol,
    //             }),
    ...
    //         expect(new BN(spotPnl.toString()).divn(10)).to.eq("0")
    //         expect(await clearingHouseViewer.getUnrealizedPnl(amm.address, alice, PnlCalcOption.TWAP)).to.eq(
    ...
    //                 await clearingHouse.openPosition(amm.address, side, margin.toString(), leverage.toString(), toDecimal(0).toString(), {
    //                     from: account,
    //                 })
    //                 await forwardBlockTimestamp(15)
    //             }
    ...
    //             await amm.setFluctuationLimitRatio(toDecimal(0.041).toString())
    ...
    //             await amm.setFluctuationLimitRatio(toDecimal(0.041).toString())
    //             traderWallet1 = await new TraderWallet__factory().deploy(clearingHouse.address, quoteToken.address)
    ...
    //             await clearingHouse.setMaintenanceMarginRatio(toDecimal(0.199).toString(), { from: admin })
    ...
    //             await amm.setFluctuationLimitRatio(toDecimal(0.06).toString())
    //             traderWallet1 = await new TraderWallet__factory().deploy(clearingHouse.address, quoteToken.address)
    ...
    //             await amm.setFluctuationLimitRatio(toDecimal(0.12).toString())
    //             traderWallet1 = await new TraderWallet__factory().deploy(clearingHouse.address, quoteToken.address)
    ...
    //             await amm.setFluctuationLimitRatio(toDecimal(0.147).toString())
    //             await clearingHouse.setPartialLiquidationRatio(toDecimal(1).toString())
    ...
    //             await syncAmmPriceToOracle()
    //             expectEvent(
    //                 await clearingHouse.liquidateWithSlippage(amm.address, alice, toDecimal(0).toString(), {
    //                     from: carol,
    //                 }),
    //                 "PositionLiquidated",
    //             )
    ...
    //             await clearingHouse.setPartialLiquidationRatio(toDecimal(0.5).toString())
    ...
    //             await amm.setFluctuationLimitRatio(toDecimal(0.07).toString())

    //             // temporarily exclude the maintenance margin ratio to openReverse
    //             await clearingHouse.setMaintenanceMarginRatio(toDecimal(0).toString(), { from: admin })

    //             await expectRevert(
    //                 clearingHouse.openPosition(amm.address, Side.SELL, toDecimal(44).toString(), toDecimal(1).toString(), toDecimal(0).toString(), {
    //                     from: alice,
    //                 }),
    ...
    //             await amm.setFluctuationLimitRatio(toDecimal(0.038).toString())
    ...
    //             await amm.setFluctuationLimitRatio(toDecimal(0.075).toString())
    ...
    //             await amm.setFluctuationLimitRatio(toDecimal(0.21).toString())
    //             await clearingHouse.setPartialLiquidationRatio(toDecimal(1).toString())
    //             traderWallet1 = await new TraderWallet__factory().deploy(clearingHouse.address, quoteToken.address)
    ...
    //             await amm.setFluctuationLimitRatio(toDecimal(0.1).toString())
    ...
    //             await clearingHouse.openPosition(amm.address, Side.SELL, toDecimal(20).toString(), toDecimal(5).toString(), toDecimal(0).toString(), {
    //                 from: bob,
    //             })
    //             await forwardBlockTimestamp(15)
    //             await clearingHouse.openPosition(amm.address, Side.SELL, toDecimal(20).toString(), toDecimal(5).toString(), toDecimal(0).toString(), {
    ...
    //             })
    //             await forwardBlockTimestamp(15)
    //             await clearingHouse.closePosition(amm.address, toDecimal(0).toString(), { from: bob })
    //             await forwardBlockTimestamp(15)
    ...
    //             })
    //             await expectRevert(
    //                 clearingHouse.closePosition(amm.address, toDecimal(0).toString(), { from: carol }),
    ...
    //             // short to make alice loss more and make insuranceFund loss more
    //             await clearingHouse.openPosition(amm.address, Side.BUY, toDecimal(20).toString(), toDecimal(5).toString(), toDecimal(0).toString(), {
    //                 from: carol,
    //             })
    //             await syncAmmPriceToOracle()
    //             await clearingHouse.liquidateWithSlippage(amm.address, alice, toDecimal(0).toString(), {
    ...
    //             await clearingHouse.openPosition(amm.address, Side.BUY, toDecimal(10).toString(), toDecimal(1).toString(), toDecimal(0).toString(), {
    //                 from: carol,
    //             })
    //             await syncAmmPriceToOracle()
    //             await clearingHouse.liquidateWithSlippage(amm.address, alice, toDecimal(0).toString(), {
    ...
    //             await clearingHouse.openPosition(amm.address, Side.SELL, toDecimal(10).toString(), toDecimal(1).toString(), toDecimal(0).toString(), {
    //                 from: carol,
    //             })
    //             await syncAmmPriceToOracle()
    //             await clearingHouse.liquidateWithSlippage(amm.address, alice, toDecimal(0).toString(), {
    ...
    //             traderWallet1 = await new TraderWallet__factory().deploy(clearingHouse.address, quoteToken.address)
    //             traderWallet2 = await new TraderWallet__factory().deploy(clearingHouse.address, quoteToken.address)
    ...
    //             await makeAliceLiquidatableByShort()
    //             await traderWallet1.openPosition(amm.address, Side.SELL, toDecimal(20).toString(), toDecimal(5).toString(), toDecimal(0).toString(), {
    //                 from: bob,
    //             })
    //             await syncAmmPriceToOracle()
    //             await traderWallet2.liquidate(amm.address, alice, toDecimal(0).toString(), { from: bob })
    ...
    //             })
    //             await syncAmmPriceToOracle()
    //             await traderWallet2.liquidate(amm.address, alice, toDecimal(0).toString(), { from: carol })
    ...
    // //         await clearingHouse.openPosition(amm.address, Side.SELL, toDecimal(20).toString(), toDecimal(5).toString(), toDecimal(11.12).toString(), {
    // //             from: bob,
    // //         })

    // //         // AMM after: 800 : 125
    // //         await clearingHouse.openPosition(amm.address, Side.SELL, toDecimal(25).toString(), toDecimal(4).toString(), toDecimal(13.89).toString(), {
    // //             from: alice,
    // //         })
    ...
    // //         // AMM after: 800 : 125
    // //         await clearingHouse.openPosition(amm.address, Side.SELL, toDecimal(20).toString(), toDecimal(5).toString(), toDecimal(13.89).toString(), {
    // //             from: alice,
    // //         })
    ...
    //         await approve(alice, clearingHouse.address, 100)
    //         await amm.setFluctuationLimitRatio(toDecimal(0.2).toString())

    //         // alice pays 20 margin * 5x long quote when 9.0909091 base
    //         // AMM after: 1100 : 90.9090909, price: 12.1000000012
    //         await expectRevert(
    //             clearingHouse.openPosition(amm.address, Side.BUY, toDecimal(20).toString(), toDecimal(5).toString(), toDecimal(9).toString(), {
    //                 from: alice,
    //             }),
    //             "price is over fluctuation limit",
    //         )
    ...
    //         await amm.setFluctuationLimitRatio(toDecimal(1).toString())

    //         // alice pays 250 margin * 1x long to get 20 base
    //         // AMM after: 1250 : 80, price: 15.625
    //         await clearingHouse.openPosition(amm.address, Side.BUY, toDecimal(250).toString(), toDecimal(1).toString(), toDecimal(0).toString(), {
    //             from: alice,
    //         })

    //         await amm.setFluctuationLimitRatio(toDecimal(0.078).toString())
    //         // AMM after: 1200 : 83.3333333333, price: 14.4
    //         // price fluctuation: (15.625 - 14.4) / 15.625 = 0.0784
    //         await expectRevert(
    //             clearingHouse.openPosition(amm.address, Side.SELL, toDecimal(50).toString(), toDecimal(1).toString(), toDecimal(0).toString(), {
    //                 from: alice,
    //             }),
    //             "price is over fluctuation limit",
    //         )
    ...
    //         // AMM after: 1100 : 90.9090909, price: 12.1000000012
    //         await clearingHouse.openPosition(amm.address, Side.BUY, toDecimal(20).toString(), toDecimal(5).toString(), toDecimal(9).toString(), {
    //             from: bob,
    //         })
    ...
    //         await forwardBlockTimestamp(15)
    //         await clearingHouse.openPosition(amm.address, Side.BUY, toDecimal(20).toString(), toDecimal(5).toString(), toDecimal(7.5).toString(), {
    //             from: alice,
    //         })

    //         await forwardBlockTimestamp(15)
    //         // set 0.5 here to avoid the above opening positions from failing
    //         await amm.setFluctuationLimitRatio(toDecimal(0.043).toString())

    //         // after alice closes her position partially, price: 13.767109
    //         // price fluctuation: (14.4000000058 - 13.767109) / 14.4000000058 = 0.0524
    //         await clearingHouse.closePosition(amm.address, toDecimal(0).toString(), { from: alice })

    //         // after bob closes his position partially, price: 13.0612
    //         // price fluctuation: (13.767109 - 13.0612) / 13.767109 = 0.04278
    //         await amm.setFluctuationLimitRatio(toDecimal(0.042).toString())
    //         await expectRevert(
    //             clearingHouse.closePosition(amm.address, toDecimal(0).toString(), { from: bob }),
    //             "price is already over fluctuation limit",
    //         )
    //     })
    ...
    //             await forwardBlockTimestamp(15)
    //             await clearingHouse.closePosition(amm.address, toDecimal(118).toString(), { from: bob })
    ...
    //                 amm.address,
    //                 Side.SELL,
    //                 toDecimal(20).toString(),
    //                 toDecimal(5).toString(),
    //                 toDecimal(11.12).toString(),
    //                 {
    //                     from: bob,
    //                 },
    //             )
    ...
    //             // AMM after: 878.0487804877 : 113.8888888889
    //             await forwardBlockTimestamp(15)
    //             await clearingHouse.closePosition(amm.address, toDecimal(79).toString(), { from: bob })
    ...
    //             await forwardBlockTimestamp(15)
    //             await expectRevert(
    //                 clearingHouse.closePosition(amm.address, toDecimal(119).toString(), { from: bob }),
    //                 "Less than minimal quote token",
    //             )
    //         })
    ...
    //             await forwardBlockTimestamp(15)
    //             await expectRevert(
    //                 clearingHouse.closePosition(amm.address, toDecimal(78).toString(), { from: bob }),
    //                 "More than maximal quote token",
    //             )
    //         })
    //     })
    ...
    //         await expectRevert(
    //             clearingHouse.openPosition(amm.address, Side.BUY, toDecimal(1).toString(), toDecimal(1).toString(), toDecimal(0).toString()),
    //             error,
    //         )
    //         await expectRevert(clearingHouse.addMargin(amm.address, toDecimal(1).toString()), error)
    //         await expectRevert(clearingHouse.removeMargin(amm.address, toDecimal(1).toString()), error)
    //         await expectRevert(clearingHouse.closePosition(amm.address, toDecimal(0).toString()), error)
    //     })
    ...
    //         await quoteToken.approve(clearingHouse.address, toFullDigit(2).toString(), { from: alice })
    //         await clearingHouse.pause()
    //         await clearingHouse.unpause()
    //         await clearingHouse.openPosition(amm.address, Side.BUY, toDecimal(1).toString(), toDecimal(1).toString(), toDecimal(0).toString(), {
    //             from: alice,
    //         })
    //         await clearingHouse.addMargin(amm.address, toDecimal(1).toString(), {
    //             from: alice,
    //         })
    //         await clearingHouse.removeMargin(amm.address, toDecimal(1).toString(), {
    //             from: alice,
    //         })
    //         await clearingHouse.closePosition(amm.address, toDecimal(0).toString(), {
    //             from: alice,
    //         })
    //     })
    ...
    //         await approve(alice, clearingHouse.address, 1000)
    //         await approve(bob, clearingHouse.address, 1000)
    //         await clearingHouse.setMaintenanceMarginRatio(toDecimal(0.2).toString())
    //         await clearingHouse.setPartialLiquidationRatio(toDecimal(1).toString())
    //     })
    ...
    //         await clearingHouse.openPosition(amm.address, Side.BUY, toDecimal(10).toString(), toDecimal(5).toString(), toDecimal(0).toString(), {
    //             from: bob,
    //         })
    //         await forwardBlockTimestamp(15)
    ...
    //                 amm.address,
    //                 Side.BUY,
    //                 toDecimal(60).toString(),
    //                 toDecimal(10).toString(),
    //                 toDecimal(0).toString(),
    //                 alice,
    //             ),
    //             "only one action allowed",
    ...
    //         await makeLiquidatableByShort(alice)
    //         await forwardBlockTimestamp(15)
    //         await traderWallet1.openPosition(amm.address, Side.SELL, toDecimal(10).toString(), toDecimal(5).toString(), toDecimal(0).toString())
    //         await syncAmmPriceToOracle()
    //         await expectRevert(
    //             traderWallet1.multiActions(
    //                 Action.LIQUIDATE,
    ...
    //         await amm.setFluctuationLimitRatio(toDecimal(0.5).toString())
    ...
    //         await makeLiquidatableByShort(alice)
    //         await traderWallet1.openPosition(amm.address, Side.SELL, toDecimal(5).toString(), toDecimal(1).toString(), toDecimal(0).toString())
    //         await forwardBlockTimestamp(15)
    ...
    //         await clearingHouse.openPosition(amm.address, Side.SELL, toDecimal(1).toString(), toDecimal(1).toString(), toDecimal(0).toString())
    //         await forwardBlockTimestamp(15)
    //         await clearingHouse.closePosition(amm.address, toDecimal(0).toString())
    //         await clearingHouse.openPosition(amm.address, Side.SELL, toDecimal(1).toString(), toDecimal(1).toString(), toDecimal(0).toString())
    //     })
